...
public class EmployeeService {
	...
	/*
	 * public String updateEmployees(Employee emp ) throws
	 * EmployeeNotFoundException{ for (Employee emp1 : list) { list.add(emp); return
	 * "Emp updated"; } throw new EmployeeNotFoundException();
	 * 
	 * 
	 * 
	 * }
